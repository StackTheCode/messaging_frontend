    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-stone-50 flex items-center justify-center p-4">
      <div className="bg-white/10 backdrop-blur-md p-12 rounded-3xl border border-white/10 shadow-2xl shadow-black/2 w-full max-w-md">
        ...
        <div className="mb-8">
          ...
          {password && (
            <div className="mt-2 text-xs text-gray-500">
              <div className={`transition-colors duration-300 ${password.length >= 8 ? 'text-green-600' : 'text-red-400'}`}>
        ...
        <button
          ...
          className="w-full bg-gray-900/90 hover:bg-gray-900 backdrop-blur-sm text-white font-light py-4 rounded-2xl transition-all duration-300 hover:shadow-lg hover:shadow-gray-900/20 tracking-wide transform hover:scale-[1.02] active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-gray-900/50 focus:ring-offset-2 focus:ring-offset-transparent"
        >
          Sign Up
        </button>
      </div>
