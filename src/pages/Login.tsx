...
export default function Login() {
    ...
    >
        ...
        <div className='mb-6 text-sm'>
            <h3 className="text-gray-500 font-light">Don't have an account? <a onClick={handleSignup} className='text-gray-700 font-normal hover:text-gray-900 transition-colors cursor-pointer border-b border-gray-300 hover:border-gray-700'>Sign Up</a></h3>
        </div>
